...
export default function Button({onClick, text, bg="", textSize="text-[12px]", textColor=""}:Props) {
    return (
        <button onClick={(e)=>{onClick(e)}} className={`w-[100%] ${textColor} ${textSize} h-[100%] font-[400] rounded-[inherit]`}>
            {text}
        </button>
    )
    // if (type == "gradient") {
